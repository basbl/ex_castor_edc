defmodule CastorEDCTest.DataCollection.Participants.RepeatingDataInstances do
  use ExUnit.Case, async: false
  use ExVCR.Mock, adapter: ExVCR.Adapter.Hackney

  import CastorEDC.DataCollection.Participants.RepeatingDataInstances

  @client CastorEDC.Client.new(%{access_token: "supersecretaccesstoken"})

  test "list/4" do
    use_cassette "participants/repeating_data_instances/repeating_data_instances#list" do
  ...
  test "find/4" do
    use_cassette "participants/repeating_data_instances/repeating_data_instances#find" do
  ...
  test "create/4 single instance" do
    use_cassette "participants/repeating_data_instances/repeating_data_instances#create-single" do
  ...
  test "create/4 multiple instances" do
    use_cassette "participants/repeating_data_instances/repeating_data_instances#create-multiple" do
