defmodule CastorEDCTest.DataCollection.Participants do
  use ExUnit.Case, async: false
  use ExVCR.Mock, adapter: ExVCR.Adapter.Hackney

  import CastorEDC.DataCollection.Participants

  @client CastorEDC.Client.new(%{access_token: "supersecretaccesstoken"})

  test "list/2" do
    use_cassette "participants/participants#list" do
  ...
  test "find/3" do
    use_cassette "participants/participants#find" do
      {200, %{"id" => record_id}, _} =
  ...
  test "create/3" do
    use_cassette "participants/participants#create" do
      {201, %{"id" => record_id}, _} =
