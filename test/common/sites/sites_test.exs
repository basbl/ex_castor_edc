defmodule CastorEDCTest.Common.Sites do
  use ExUnit.Case, async: false
  use ExVCR.Mock, adapter: ExVCR.Adapter.Hackney

  import CastorEDC.Common.Sites

  @client CastorEDC.Client.new(%{access_token: "supersecretaccesstoken"})

  test "list/2" do
    use_cassette "sites/sites#list" do
  ...
  test "find/3" do
    use_cassette "sites/sites#find" do
  ...
  test "create/3 single" do
    use_cassette "sites/sites#create_single" do
  ...
  test "create/3 multiple" do
    use_cassette "sites/sites#create_multiple" do
