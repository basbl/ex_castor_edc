defmodule CastorEDCTest.StudyProtocol.SurveyForms do
  use ExUnit.Case, async: false
  use ExVCR.Mock, adapter: ExVCR.Adapter.Hackney

  import CastorEDC.StudyProtocol.SurveyForms

  @client CastorEDC.Client.new(%{access_token: "supersecretaccesstoken"})

  test "list/2" do
    use_cassette "survey_forms/survey_forms#list" do
      {200, survey_steps, _} =
        list(
          @client,
  ...
  test "find/3" do
    use_cassette "survey_forms/survey_forms#find" do
