defmodule CastorEDCTest.StudyProtocol.RepeatingDataForms do
  use ExUnit.Case, async: false
  use ExVCR.Mock, adapter: ExVCR.Adapter.Hackney

  import CastorEDC.StudyProtocol.RepeatingDataForms

  @client CastorEDC.Client.new(%{access_token: "supersecretaccesstoken"})

  test "list/2" do
    use_cassette "repeating_data_forms/repeating_data_forms#list" do
      {200, report_steps, _} =
        list(
          @client,
  ...
  test "find/3" do
    use_cassette "repeating_data_forms/repeating_data_forms#find" do
