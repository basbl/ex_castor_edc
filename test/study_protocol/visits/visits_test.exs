defmodule CastorEDCTest.StudyProtocol.Visits do
  use ExUnit.Case, async: false
  use ExVCR.Mock, adapter: ExVCR.Adapter.Hackney

  import CastorEDC.StudyProtocol.Visits

  @client CastorEDC.Client.new(%{access_token: "supersecretaccesstoken"})

  test "list/2" do
    use_cassette "visits/visits#list" do
  ...
  test "find/3" do
    use_cassette "visits/visits#find" do
      {200, %{"id" => phase_id}, _} =
        find(
          @client,
